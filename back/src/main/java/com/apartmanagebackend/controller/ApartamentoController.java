...
import com.apartmanagebackend.service.ApartamentoService;
...
public class ApartamentoController {
    ...
    public ResponseEntity<List<com.apartmanagebackend.dto.apartamento.DocumentoResponse>> obtenerDocumentos(
            @PathVariable Long id,
            Principal principal
    ) {
